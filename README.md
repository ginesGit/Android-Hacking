...
Android APK Backdoor Injection. 
Writeup de laboratorio.
...
Túnel Pinggy	Establecimiento del túnel TCP	Túnel Pinggy
Generación payload	Output de msfvenom	Payload
Código smali	Inyección en onCreate	Smali
Permisos	Manifest con permisos inyectados	Permisos
Instalación	App instalándose en el S9	Instalación
Sesión Meterpreter	Conexión establecida	Meterpreter
Post-explotación	sysinfo y shell	Post-explotación
